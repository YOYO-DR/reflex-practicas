...
def new_item() -> rx.Component:
    ...
    return rx.form(
        ...
        rx.center(
            ...
            rx.link("Portafolio",href="https://portafolioyoiner.azurewebsites.net/notas/django/",rel="noopener noreferrer",style=dict(border="1px solid",border_radius="5px",padding="5px"))
            )
